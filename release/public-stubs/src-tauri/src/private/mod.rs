//! Private feature stubs for the free build.
//!
//! Shared `lib.rs` registers these commands, so the free edition keeps matching
//! symbols for compilation. Implementations intentionally return an error and
//! no private feature implementation is compiled into the distributed binary.
